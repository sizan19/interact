...
function utils.drawOption(coords, text, spriteDict, spriteName, row, width, showDot)
    SetScriptGfxAlignParams((showDot == true and 0.029 or 0.016) + (width / 6.5), row * 0.03 - 0.0123, 0.1, 0.0)
    SetTextScale(0, 0.3)
    SetTextFont(4)
    ...
    SetScriptGfxAlignParams((showDot == true and 0.034 or 0.019) + (width / 2), row * 0.03 - 0.015, 0.0, 0.0)
    ...
    if showDot then
        ...
        SetScriptGfxAlignParams(0.024, row * 0.03 - 0.015, 0.0, 0.0)
        DrawSprite(spriteDict, newSpritename, 0.0, 0.014, 0.013, 0.023, 0.0, 255, 255, 255, 255)
        ResetScriptGfxAlign()
    end
